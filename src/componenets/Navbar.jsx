  ...
  return (
    ...
    <nav className='md:flex md:justify-between md:gap-6 md:items-center ' >
      ...
      {isOpen && <motion.ul     variants={container}
        ...
        <motion.li variants={item} className={`rounded-full my-3 md:my-0 relative  hover:text-[#efefefc8] transition-colors duration-150 md:p-2 md:py-4 md:px-6 lg:py-5 lg:px-11  ${clickedItem === 2 ? 'md:border-[#8C72F4] md:border-[1px]' : ''}`} onClick={(prv) => {
