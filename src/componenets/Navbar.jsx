 ...
 variants={item} className={`rounded-full my-3 md:my-0 relative  hover:text-[#efefefc8] transition-colors duration-150 md:p-2 md:py-4 md:px-6 lg:py-5 lg:px-11  ${clickedItem === 2 ? 'md:border-[#8C72F4] md:border-[1px]' : ''}`} onClick={(prv) => {
         ...
         >
           {featureSubmenu.map((feature, index) => (
             <div key={index} variants={item} className='flex gap-4'>
        ...
        <li variants={item} className={`rounded-full my-3 md:my-0 md:p-2  hover:text-[#efefefc8] transition-colors duration-150 md:py-4 md:px-6 lg:py-5 lg:px-11 ${clickedItem === 5 ? 'md:border-[#8C72F4] md:border-[1px]' : ''}`} onClick={() => handleItemClick(5)}>Partners</li>
        <li variants={item} className={`rounded-full my-3 md:my-0 md:p-2  hover:text-[#efefefc8] transition-colors duration-150 md:py-4 md:px-6 lg:py-5 lg:px-11  ${clickedItem === 6 ? 'md:border-[#8C72F4] md:border-[1px]' : ''}`} onClick={() => handleItemClick(6)}>Ressources</li>
      </ul>}
