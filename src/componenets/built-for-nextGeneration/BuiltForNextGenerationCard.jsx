...
const BuiltForNextGenerationCard = ({id,onClick,className, img1Src,img2Src, title, desc }) => {
  console.log(id)
  return (
    <Card onClick={onClick} className={`cursor-pointer hover:border-[#8C72F4] transition duration-500 hover:border-[1px] h-full py-6 px-4 w-full ${id === 4 ? "hidden md:block": ""} md:p-6 md:py-8 ${className} `}>
